 ...
 */
    ...
    (() => {
        ...
        let _slideUp = (target, duration = 500, showmore = 0, callback) => {
            if (!target.classList.contains("_slide")) {
                target.classList.add("_slide");
                let currentHeight = target.offsetHeight;
                if ("auto" === target.style.height) {
        ...
        let _slideDown = (target, duration = 500, showmore = 0, callback) => {
            if (!target.classList.contains("_slide")) {
                target.classList.add("_slide");
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if ("items" === showMoreType) {
                        ...
                        if (window.innerWidth <= 768 && isLeftSearchTopBlock) showMoreTypeValue = 6; else if (window.innerWidth <= 768 && isTabsDescrBlock) showMoreTypeValue = 6; else if (window.innerWidth <= 600 && showMoreContent.classList.contains("block-services__body")) showMoreTypeValue = 3;
                        ...
                        for (let index = 1; index <= showMoreItems.length; index++) {
                            ...
                            if (index < showMoreTypeValue && index < showMoreItems.length) hiddenHeight += gap;
                ...
                function showMoreActions(e) {
                    ...
                    if ("click" === targetType) {
                        if (targetEvent.closest("[data-showmore-button]")) {
                            ...
                            if (!showMoreContent.classList.contains("_slide")) if (isCollapsing) _slideUp(showMoreContent, showMoreSpeed, hiddenHeight, (() => {
                    ...
                    } else if ("resize" === targetType) if (showMoreBlocksRegular && showMoreBlocksRegular.length) showMoreBlocksRegular.forEach((showMoreBlock => {
                        const showMoreContent = showMoreBlock.querySelector("[data-showmore-content]");
        ...
        document.querySelectorAll(".images-product__thumb").forEach((thumb => {
            ...
            parent.querySelector(".images-product__thumbs");
            const thumbsSwiper = new core(thumb, {
...
***************************************************************************** */
        ...
        if (header) window.addEventListener("scroll", (function() {
            if (window.scrollY > 0) header.classList.add("_header-scroll"); else header.classList.remove("_header-scroll");
        }));
        function sticky() {
        ...
        if (selectElements2) selectElements2.forEach((selectElement => {
            ...
            optionInputs.forEach((input => {
                input.addEventListener("change", (function() {
                    selectElement.querySelectorAll(".options__input:checked").length;
                }));
            }));
            document.addEventListener("click", (function(event) {
                if (!selectElement.contains(event.target)) selectElement.classList.remove("active");
            }));
        }));
        window["FLS"] = false;
        isWebp();
